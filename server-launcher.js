...
// Pode ser sobrescrito por variáveis de ambiente, útil em VPS com pouca RAM:
// MC_MIN_MEMORY=256M MC_MAX_MEMORY=512M npm run dev
const MIN_MEMORY = process.env.MC_MIN_MEMORY || '2G';
const MAX_MEMORY = process.env.MC_MAX_MEMORY || '4G';
